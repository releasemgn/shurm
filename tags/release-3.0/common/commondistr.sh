...
function f_distr_readitem() {
	...
	f_distr_getxmllineattr distitem deployversion
	C_DISTR_DEPLOYVERSION=$C_DISTR_XMLLINEATTR
	if [ "$C_DISTR_DEPLOYVERSION" = "" ]; then
		C_DISTR_DEPLOYVERSION=default
	fi

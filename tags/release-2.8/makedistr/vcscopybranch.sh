...
function f_local_vcs_copybranch_svn() {
	...
	svn copy $P_SVNAUTH $P_SVNPATH/$P_VCS_PATH/$MODULE/$BRANCH1X $P_SVNPATH/$P_VCS_PATH/$MODULE/$BRANCH2X -m "$C_CONFIG_ADM_TRACKER-0000: copy branch"
}
...
echo vcscopybranch.sh: finished MODULE=$MODULE, MODULEPATH=$MODULEPATH, BRANCH1=$BRANCH1, BRANCH2=$BRANCH2

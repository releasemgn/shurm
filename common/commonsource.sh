...
C_SOURCE_BUILDERTYPE=
C_SOURCE_BUILDERVERSION=
...
function f_source_readproject() {
	...
	f_source_getxmllineattr project buildertype
	C_SOURCE_BUILDERTYPE=$C_SOURCE_XMLLINEATTR
	f_source_getxmllineattr project builderversion
	C_SOURCE_BUILDERVERSION=$C_SOURCE_XMLLINEATTR

...
if [ "$C_CUSTOM_SERVICECALL_EXT" != "" ]; then
	S_SERVICECALL_EXT=$C_CUSTOM_SERVICECALL_EXT
fi

S_STORAGESERVICE_EXT=ear
if [ "$C_CUSTOM_STORAGESERVICE_EXT" != "" ]; then
	S_STORAGESERVICE_EXT=$C_CUSTOM_STORAGESERVICE_EXT
fi

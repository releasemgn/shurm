...
C_REDIST_DEPLOY_CONTENT_CONFIG=
C_REDIST_DEPLOY_CONTENT_VER=
C_REDIST_DEPLOY_BACKUP_CONTENT=
C_REDIST_DEPLOY_BACKUP_CONTENT_CONFIG=
C_REDIST_DEPLOY_BACKUP_CONTENT_VER=
...
function f_redist_getlocationinfo() {
	...
	C_REDIST_DEPLOY_CONTENT_CONFIG=$C_REDIST_DIRITEMS_CONFIG
	C_REDIST_DEPLOY_CONTENT_VER=$C_REDIST_DIRITEMS_VER
	...
	C_REDIST_DEPLOY_BACKUP_CONTENT_CONFIG=$C_REDIST_DIRITEMS_CONFIG
	C_REDIST_DEPLOY_BACKUP_CONTENT_VER=$C_REDIST_DIRITEMS_VER

...
function f_admindb_add_beginscriptstatus() {
	...
	echo "DECLARE"
	echo "  L_USER varchar2(30);"
	echo "  FK_SCRIPTS_RELEASE EXCEPTION;"
	echo "  PRAGMA EXCEPTION_INIT (FK_SCRIPTS_RELEASE, -02291);"
	echo "BEGIN"
	echo " SELECT sys_context('USERENV','OS_USER') into L_USER from dual;"
	...
	echo " VALUES ('$C_ADMINDB_REL_FULL', '$F_SCHEMA', $P_SCRIPTNUM, '$P_SCRIPTNAME', SYSDATE, L_USER, 'S');"
	echo " COMMIT;"
	echo "EXCEPTION WHEN FK_SCRIPTS_RELEASE THEN"
